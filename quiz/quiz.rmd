...
**1. Counties with missing upward mobility measure**
...
**2. Counties with population density of 0**
...
**3. Filter data to keep counties with non-missing population density greater than 0 and non-missing upward mobility measure**
...
-> For each one unit increase in `log_popdensity_2000`, there is a 1.12 percent decrease (?)
